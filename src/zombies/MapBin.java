...
public class MapBin {
    ...
    static Map getRoom2Map() {
        Map zombietwo = new Map(ResourceTools.loadImageFromResource("resources/zombie_room_05.png"), new Dimension(32, 32), new Dimension(50, 50));
    
        return zombietwo;
    }
    
    public static Map getRoom1Map() {
