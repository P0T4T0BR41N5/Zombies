...
public class MapBin {
   public static Map getZombieMap(){
        ...
        //Map.addObstacleRange(zombieMap, new Point(7, 18), new Point(16, 18), ObstacleType.WATER);
                ...
                Map.addObstacleRange(zombieMap, new Point(71, 19), new Point(71, 22), ObstacleType.BARRIER);Map.addObstacleRange(zombieMap, new Point(74, 0), new Point(74, 26), ObstacleType.BARRIER);
 Map.addObstacleRange(zombieMap, new Point(0, 3), new Point(5, 3), ObstacleType.BARRIER);
                ...
                Map.addObstacleRange(zombieMap, new Point(34, 1), new Point(34, 26), ObstacleType.BARRIER);
